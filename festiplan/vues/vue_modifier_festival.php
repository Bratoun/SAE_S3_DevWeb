...
<body class="body-blanc">
    <form action="index.php" method="post">
        ...
        <div class="form-group texteGauche">
            ...
            if($estResponsable) {?>
                <a href="/festiplan?controller=Festival&action=gestionOrganisateur&idFestival=<?php echo $idFestival;?>"><button type="button" class="btn btn-gris">ajouter des Organisateur</button></a>  
            <?php } ?>
        </div>
        <div class="footer">
            ...
            <a href="/festiplan?controller=Festival&action=modifierListeSpectacleFestival&idFestival=<?php echo $idFestival;?>"><button type="button" class="btn btn-bleu">Modifier la liste des spectacles</button></a>
        </div>
    </form>
</body>
</html>