...
<body class="body-blanc">
    <form action="index.php" method="post">
        ...
        <div class="form-group texteGauche">
            ...
            if($estResponsable) {?>
                <a href="/festiplan?controller=Festival&action=gestionOrganisateur&idFestival=<?php echo $idFestival;?>"><button type="button" class="btn btn-gris">gérer les Organisateur</button></a>  
            <?php } ?>
        </div>
        <div class="footer">
